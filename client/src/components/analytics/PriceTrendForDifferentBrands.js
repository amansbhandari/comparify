...
function generateOptions(categories, data) {
...
const PriceTrendForDifferentBrands = (props) => {
    ...
    useEffect(() => {
        ...
        if (!categories || categories.length === 0) {
            ...
            setPriceData(generateOptions(categories, brandTrend))
        }
    ...
    return (<Box sx={{margin: "0% 0px 5% 0px"}}>
                <Typography variant='h4' sx={{textAlign: "center", marginBottom: "20px"}}>
            {"Product Price trend for different Brands"}</Typography>
        <Box>
...
export default PriceTrendForDifferentBrands;